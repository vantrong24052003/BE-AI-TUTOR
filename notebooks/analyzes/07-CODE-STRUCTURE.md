...
| **LESSONS** |
| 15 | lesson_controller.py | GET | /api/courses/{id}/lessons | Danh sách bài học |
| 16 | lesson_controller.py | GET | /api/lessons/{id} | Chi tiết bài học |
| 17 | lesson_controller.py | POST | /api/courses/{id}/lessons | Tạo bài học mới |
| 18 | lesson_controller.py | PUT | /api/lessons/{id} | Cập nhật bài học |
| 19 | lesson_controller.py | DELETE | /api/lessons/{id} | Xóa bài học |
| **QUIZZES** |
| 20 | quiz_controller.py | GET | /api/lessons/{id}/quiz | Lấy quiz của bài học |
| 21 | quiz_controller.py | GET | /api/quizzes/{id} | Chi tiết quiz |
| 22 | quiz_controller.py | POST | /api/quizzes | Tạo quiz mới |
| 23 | quiz_controller.py | PUT | /api/quizzes/{id} | Cập nhật quiz |
| 24 | quiz_controller.py | DELETE | /api/quizzes/{id} | Xóa quiz |
| **QUIZ SUBMISSION** |
| 25 | quiz_controller.py | POST | /api/quizzes/{id}/submit | Nộp bài làm quiz |
| 26 | quiz_controller.py | GET | /api/quizzes/{id}/attempts | Lịch sử làm quiz |
| **CHAT** |
| 27 | chat_controller.py | GET | /api/chat/conversations | Danh sách conversations |
| 28 | chat_controller.py | GET | /api/chat/conversations/{id} | Chi tiết conversation |
| 29 | chat_controller.py | POST | /api/chat/conversations | Tạo conversation mới |
| 30 | chat_controller.py | DELETE | /api/chat/conversations/{id} | Xóa conversation |
| **MESSAGES** |
| 31 | chat_controller.py | GET | /api/chat/conversations/{id}/messages | Danh sách tin nhắn |
| 32 | chat_controller.py | POST | /api/chat/conversations/{id}/messages | Gửi tin nhắn + AI response |
| **PROGRESS** |
| 33 | progress_controller.py | GET | /api/progress | Tiến độ tổng quan |
| 34 | progress_controller.py | GET | /api/progress/courses/{id} | Tiến độ theo khóa học |
| 35 | progress_controller.py | POST | /api/progress/lessons/{id}/complete | Đánh dấu hoàn thành |
| **DOCUMENTS** |
| 36 | document_controller.py | GET | /api/courses/{id}/documents | Danh sách tài liệu |
| 37 | document_controller.py | GET | /api/documents/{id} | Download tài liệu |
| 38 | document_controller.py | POST | /api/courses/{id}/documents | Upload tài liệu |
| 39 | document_controller.py | DELETE | /api/documents/{id} | Xóa tài liệu |
